...
void CBaseEntity::FireBullets(ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iTracerFreq, int flashRadius, int iDamage, entvars_t *pevAttacker ) { }	// jay - new var
