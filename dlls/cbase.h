...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	void		FireBullets( ULONG	cShots, Vector  vecSrc, Vector	vecDirShooting,	Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq = 4, int flashRadius = 16, int iDamage = 0, entvars_t *pevAttacker = NULL );	// jay - added new var
