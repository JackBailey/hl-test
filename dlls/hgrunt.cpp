...
void CHGrunt :: Shoot ( void )
{
	...
	FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_10DEGREES, 2048, BULLET_MONSTER_MP5, 1 ); // shoot +-5 degrees	// jay - changed tracerfreq
...
void CHGrunt :: Shotgun ( void )
{
	...
	FireBullets(gSkillData.hgruntShotgunPellets, vecShootOrigin, vecShootDir, VECTOR_CONE_15DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 1 ); // shoot +-7.5 degrees	// jay - changed tracerfreq from 0
