...
*/
	...
	m_pPlayer->FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_357, 1, 20 );	// jay - changed tracerfreq from 0 and added flashRadius
...
class CPythonAmmo : public CBasePlayerAmmo
{
	...
	{ 
		if (pOther->GiveAmmo( AMMO_357BOX_GIVE, "357", _357_MAX_CARRY ) != -1)
		{
			...
			{
			case 0:
				EMIT_SOUND( ENT(pev), CHAN_ITEM, "items/ammopickup1.wav", VOL_NORM, ATTN_NORM );
				break;
			case 1:
				EMIT_SOUND( ENT(pev), CHAN_ITEM, "items/ammopickup2.wav", VOL_NORM, ATTN_NORM );
				break;
			}
			return TRUE;
		}
