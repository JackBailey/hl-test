...
void CMP5::PrimaryAttack()
{
	...
	m_pPlayer->FireBullets( 1, vecSrc, vecAiming, VECTOR_CONE_3DEGREES, 8192, BULLET_PLAYER_MP5, 1, 24 );	// jay - always use singleplayer spread, changed tracerfreq from 2 and added flashRadius
