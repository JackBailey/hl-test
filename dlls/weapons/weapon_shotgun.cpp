...
void CShotgun::PrimaryAttack()
{
	...
	m_pPlayer->FireBullets( 6, vecSrc, vecAiming, VECTOR_CONE_10DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 1, 24 );	// jay - always use singleplayer spread, changed tracerfreq from 0 and added flashRadius
...
void CShotgun::SecondaryAttack( void )
{
	...
	m_pPlayer->FireBullets( 12, vecSrc, vecAiming, VECTOR_CONE_10DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 1, 32 );	// jay - always use singleplayer spread, changed tracerfreq from 0 and added flashRadius
...
class CShotgunAmmo : public CBasePlayerAmmo
{
	...
	{ 
		...
		{
			EMIT_SOUND(ENT(pev), CHAN_ITEM, pAmmoSounds[ RANDOM_LONG( 1, 3 ) ], VOL_NORM, ATTN_NORM);	// jay - ammo pickup sound
			return TRUE;
		}
		return FALSE;
	}
